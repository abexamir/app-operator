...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DockerImageSource) DeepCopyInto(out *DockerImageSource) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DockerImageSource.
func (in *DockerImageSource) DeepCopy() *DockerImageSource {
	if in == nil {
		return nil
	}
	out := new(DockerImageSource)
	in.DeepCopyInto(out)
	return out
}
